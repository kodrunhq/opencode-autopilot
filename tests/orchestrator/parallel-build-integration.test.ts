...
function makeBuildState(
	...
	return pipelineStateSchema.parse({
		...
		lastUpdatedAt: now,
		phases: [
			{ name: "RECON", phaseNumber: 1, status: "DONE" },
			{ name: "CHALLENGE", phaseNumber: 2, status: "DONE" },
			{ name: "ARCHITECT", phaseNumber: 3, status: "DONE" },
			{ name: "EXPLORE", phaseNumber: 4, status: "SKIPPED" },
			{ name: "PLAN", phaseNumber: 5, status: "DONE" },
			{ name: "BUILD", phaseNumber: 6, status: "IN_PROGRESS" },

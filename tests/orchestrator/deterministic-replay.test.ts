...
describe("deterministic replay", () => {
	...
	test("parallel BUILD dispatches both wave-1 tasks, then completes them individually", async () => {
		...
		const customState = {
			...
			lastUpdatedAt: now,
			phases: [
				{ name: "RECON", phaseNumber: 1, status: "DONE", completedAt: now, confidence: null },
				{ name: "CHALLENGE", phaseNumber: 2, status: "DONE", completedAt: now, confidence: null },
				{ name: "ARCHITECT", phaseNumber: 3, status: "DONE", completedAt: now, confidence: null },
				{ name: "EXPLORE", phaseNumber: 4, status: "DONE", completedAt: now, confidence: null },
				{ name: "PLAN", phaseNumber: 5, status: "DONE", completedAt: now, confidence: null },
				{
					name: "BUILD",
					phaseNumber: 6,
					status: "IN_PROGRESS",
				...
				{ name: "SHIP", phaseNumber: 7, status: "PENDING", completedAt: null, confidence: null },
				{
					name: "RETROSPECTIVE",
					phaseNumber: 8,
					status: "PENDING",

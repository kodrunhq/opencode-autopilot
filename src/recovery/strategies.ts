...
function retryWithBackoff(category: ExtendedErrorCategory): RecoveryStrategyResolver {
	return (context) => {
...
function fallbackModel(category: ExtendedErrorCategory): RecoveryStrategyResolver {
	return (context) =>
...
function compactAndRetry(category: ExtendedErrorCategory): RecoveryStrategyResolver {
	return (context) =>
...
function restartSession(category: ExtendedErrorCategory): RecoveryStrategyResolver {
	return (context) =>
...
function reduceContext(category: ExtendedErrorCategory): RecoveryStrategyResolver {
	return (context) =>
...
function skipAndContinue(category: ExtendedErrorCategory): RecoveryStrategyResolver {
	return (context) =>
...
function userPrompt(category: ExtendedErrorCategory): RecoveryStrategyResolver {
	return (context) => createAction("user_prompt", category, context.maxAttempts, 0);
}

function abort(category: ExtendedErrorCategory): RecoveryStrategyResolver {
	return (context) => createAction("abort", category, context.maxAttempts, 0);
}

export function getStrategy(category: ExtendedErrorCategory): RecoveryStrategyResolver {
	switch (category) {
		case "rate_limit":
		case "timeout":
		case "network":

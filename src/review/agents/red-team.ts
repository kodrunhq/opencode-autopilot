...
6. **Severity Upgrades** -- Review existing findings from other agents. Can any be upgraded? A "MEDIUM" code quality issue combined with a "MEDIUM" security issue might be "CRITICAL" in combination.
...
{"file": "path/to/file", "line": 42, "severity": "CRITICAL", "agent": "red-team", "finding": "description", "suggestion": "how to fix"}
